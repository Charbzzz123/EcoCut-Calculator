...
- Continue Start Next Job enhancements with deeper assignment performance drill-down (e.g., per-employee trend charts, route-level variance) now that analytics, date-range filtering, optimistic lifecycle reconciliation, and CSV export are live.
